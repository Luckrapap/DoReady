                ...
                <AnimatePresence>
                    {isSelectionMode && (
                        <motion.div 
                            ...
                            animate={{ y: 0 }}
                            exit={{ y: -100 }}
                            className="fixed top-0 left-0 right-0 z-[110] bg-white dark:bg-black border-b border-zinc-200 dark:border-zinc-800 px-6 pb-4 pt-[calc(var(--safe-area-inset-top,24px)+12px)] flex items-center justify-between shadow-xl"
                        >
                    ...
                    {view === 'list' ? (
                        <motion.div
                            ...
                            style={{ height: viewportHeight }}
                             className="absolute top-0 left-0 right-0 flex flex-col pt-[105px]"
                        >
                            <header className={cn(
