                    ...
                    {view === 'list' ? (
                        <motion.div
                            ...
                            style={{ height: viewportHeight }}
                             className="absolute top-0 left-0 right-0 flex flex-col pt-[28px]"
                        >
                            <header className={cn(
                        ...
                        <motion.div
                            ...
                            style={{ height: viewportHeight }}
                            className="absolute top-0 left-0 right-0 flex flex-col px-6 pt-[28px] bg-zinc-50 dark:bg-zinc-950"
                        >
