                ...
                <AnimatePresence>
                    {isSelectionMode && (
                        <motion.div 
                            ...
                            animate={{ y: 0 }}
                            exit={{ y: -100 }}
                            className="fixed top-0 left-0 right-0 z-[110] bg-white dark:bg-black border-b border-zinc-200 dark:border-zinc-800 px-6 py-4 pt-[calc(1rem+var(--safe-area-inset-top))] flex items-center justify-between shadow-xl"
                        >
                ...
                <AnimatePresence initial={false} custom={direction}>
                    {view === 'list' ? (
                        <motion.div
                            ...
                            className={cn(
                                "absolute top-0 left-0 right-0 flex flex-col transition-all duration-500",
                                isSelectionMode ? "pt-24" : "pt-8"
                            )}
                        >
                            <header className={cn(
