    ...
    return (
        ...
        >
            <div className="w-full max-w-3xl">
                ...
                <header className="mb-20 flex flex-col items-center justify-center text-center gap-4 relative w-full pt-16 md:pt-0">
                    <Link 
                        href="/habits" 
                        className="absolute left-0 top-0 md:top-14 inline-flex items-center gap-2 text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors font-medium text-sm"
                    >
                        <ChevronLeft size={20} />
                        Back to Habits
                    </Link>
